...
class ResNeXt(nn.Module):
    ...
    def __init__(self, baseWidth, cardinality, layers, last_stride):
        """ Constructor
        Args:
...
def resnext50_ibn_a(baseWidth, cardinality, last_stride):
    """
    Construct ResNeXt-50.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 6, 3], last_stride)
    return model


def resnext101_ibn_a(baseWidth, cardinality, last_stride):
    """
    Construct ResNeXt-101.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 4, 23, 3], last_stride)
    return model


def resnext152_ibn_a(baseWidth, cardinality, last_stride):
    """
    Construct ResNeXt-152.
    """
    model = ResNeXt(baseWidth, cardinality, [3, 8, 36, 3], last_stride)
    return model