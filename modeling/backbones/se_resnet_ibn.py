...
def se_resnet50_ibn_a(last_stride=1):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(SEBottleneck, [3, 4, 6, 3], last_stride=last_stride)
...
def se_resnet101_ibn_a(last_stride=1):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(SEBottleneck, [3, 4, 23, 3], last_stride=last_stride)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model


def se_resnet152_ibn_a(last_stride=1):
    """Constructs a ResNet-152 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(SEBottleneck, [3, 8, 36, 3], last_stride=last_stride)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model