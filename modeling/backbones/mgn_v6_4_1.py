# mgn_v6_4_1：相对于v6，减少了分支的deepcopy特征，仅deepcopy layer4的特征；而且p1的conv1的stride=2
import copy
import torch
...
class MGN(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.training:
            ...
            return predict, (predict, fea0, fea1_0, fea1_1), (cls0, cls1_0, cls1_1)
        else:
            return predict
