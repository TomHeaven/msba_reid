...
class Baseline(nn.Module):
    ...
    def __init__(self, 
        ...
        if True:
            ...
            ## mgn
                ...
                self.base = MGN(num_classes, 'resnet50', last_stride, with_ibn, gcb, stage_with_gcb, with_abd=False)
            elif backbone == 'mgn_resnet101':
                self.base_type = MGN_RESNET101
                self.base = MGN(num_classes, 'resnet101', last_stride, with_ibn, gcb, stage_with_gcb, with_abd=False)
        ...
        if self.base_type not in [MGN_RESNET101, MGN_RESNEXT101]:
    ...
    def load_params_wo_fc(self, state_dict):
        ...
        for k in state_dict.keys():
            if k =='classifier.weight' or k.startswith('base.fc_id_'):
