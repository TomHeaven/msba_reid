...
MODEL.NAME 'aligned_resnet101_ibn_alldata' \
MODEL.BACKBONE 'aligned_resnet101' \
MODEL.WITH_IBN 'True' \
TEST.WEIGHT '/Volumes/Data/比赛/行人重识别2019/logs/competition1910/all_data/aligned_resnet101_ibn_bs63/ckpts/model_best.pth'
