...
MODEL.PRETRAIN_PATH '/media/tomheaven/MacOS/Users/tomheaven/.cache/torch/checkpoints/resnet50_ibn_a.pth.tar' \
TEST.WEIGHT 'logs/competition1910/resnet50_ibn_bs63/ckpts/model_best.pth' \